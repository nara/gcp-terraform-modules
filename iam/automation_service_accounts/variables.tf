...
variable "create_cloud_sql_sa" {
  description = "Set to true to create a SA for cloud sql automation"
  type = bool
  default = false
}

variable "create_global_app_sa" {
  description = "Set to true to create a SA for global cloud sa"
  type = bool
  default = false
}
